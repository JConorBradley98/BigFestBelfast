...
<form action="restrictaccount.php" method="post">
<div class="form-group-inline text-center" id="loggroup">
<h1 class="formh"> Restrict Account </h1>
...
<input class = "form-control"  id="logcon" type = "number" name="id" placeholder="id">
</div>
</div>
<div class="row justify-content-center">
<div class = "logdiv center-block">
<input  lass = "form-control"  id="logcon" type = "submit" value="Restrict">
</div>
</div>
