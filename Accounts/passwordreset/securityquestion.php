...
$emailcheck->bind_param("s", $_POST['em']);
$emailcheck->execute();
...
while ($row = $emailcheckresult->fetch_assoc()) {


    $securityquestion = $row['secques'];
    $email = $_POST['em'];
}
?>
...
<html>
    ...
    <a href ="publicuserpage.php">  <img src ='img/usersicon.png' class='img-fluid navicon' style='height:30px; width:30px'> </a>
            ...
            <div class="col-xl-12 text-center" style ="height:724px;"id="con">
                ...
                <form action="processloggedoutpassreset.php" method="post">
                    <div class="form-group-inline text-center" id="loggroup">
                        <h1 class="formh"> Reset Password Step 2  </h1>
<?php echo"<h1 class='formh'>"; echo htmlescape($securityquestion); echo" </h1>"; ?> 
                        <div class="row justify-content-center">
                            <div class="logdiv center-block text-center">
                                <h1 class="formh"> Enter Answer </h1>
                                <input class = "form-control" id="logcon" type ="text" name = "answer" placeholder="Security Question Answer" required> 
                                <input type = "hidden" value='<?php echo htmlescape($email); ?>' name = "email">
                            </div>
                        </div>
                        <div class="row justify-content-center">
                            <div class="logdiv center-block text-center">
                                <h1 class="formh"> Enter new Password </h1>
                                <input class = "form-control" id="logcon" type ="password" oninvalid="alert('Password must be at least 10 characters and contain a special character, an uppercase letter, a lower case letter and a number')" minlength ="10" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"  name = "password" placeholder="New Password" requried> 
                            </div>
                        </div>
                    </div>
                    <div class="row justify-content-center">
