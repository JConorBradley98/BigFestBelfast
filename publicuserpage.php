...
if (isset($_GET["publicusers"])) {
    $publicpage = $_GET["publicusers"];
} else {
    $publicpage = 1;
};
$publicstart = ($publicpage - 1) * $userresults;
$userread = "SELECT * FROM user WHERE usertype ='public' LIMIT " . "$publicstart" . " , " . "$userresults";


$userresult = $conn->query($userread);

$publiccount = "SELECT COUNT(ID) AS total FROM user WHERE usertype = 'public'";
$countresult = $conn->query($publiccount);
...
$totalpublicpage = ceil($totalrows / $userresults);
?>
...
echo "<li class='nav-item'>
      <a class='nav-link active' href='publicuserpage.php'>View Standard Users</a>
...
?>
            ...
            <div class = "container-fluid">
                <div class = "col-xl-12 searchdiv">
                    ...
                    <form action = "searchedpublicuser.php" class ="form-group" method ="post">
                        <div class ="form-row">
                            <div class = "col-xl-2">
                                <label for ="username"><h2 class='footertext'> Search for a Public User </h2> </label>
                            </div>
                            <div class = "col-xl-2">
...
<div class = "col-xl-12 btn-group" style="text-align:center;">
                ...
                <?php
                for ($i = 1; $i <= $totalpublicpage; $i++) {
                    echo "<div style='padding-left:50px; padding=right:50px'> <a href='publicuserpage.php?publicusers=" . $i . "'><button type ='button' class = 'btn btn-danger'> $i </button> </a> </div> ";
                }
                ?>
