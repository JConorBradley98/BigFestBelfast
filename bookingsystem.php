...
$showtitle = "SELECT * FROM showpage INNER JOIN showdb on showdb.id = showpage.showid";


$showdetailsres = $conn->query($showtitle) or die ($conn -> error);
...
while($showtitle = $showdetailsres->fetch_assoc()){

  $showqueryres = $showtitle ["title"];
  $showstartdate = $showtitle ["showdate"];
  $showenddate = $showtitle ["endate"];
...
?>
        ...
        <div class="contain-fluid">
            ...
            <div class="row"> <!--Row Begins-->
                ...
                <div class="col-xl-4">  <!---Booking Div Begins ---->
                    ...
                    <input type = "text" id="attendeefname" name ="fname"><br>
                    
                    <label for="attendeesname">Surname:</label> 
                    <input type ="text" id="attendeesname" name ="sname"><br>
    ...
    <tbody>
      <tr>
        <td><?php echo ""; ?></td> <!-----Venue----->
        <td><?php echo "$showqueryres";?></td> <!-----Show-----> 
        <td><?php echo ""; ?>  </td>  <!-----Performer-----> 
        <td><?php echo "$showstartdate";?>  </td>    <!-----Show start Date-----> 
        <td><?php echo "$showenddate";?>  </td>   <!-----Show End date----->
      </tr>
      <tr>
        <td><?php echo "";?>  </td>
        <td><?php echo "";?>  </td>
