...
$recipient = "SELECT * FROM user WHERE id  != $user";
$recipientresult = $conn->query($recipient);
?>
...
?>
            ...
            <div class="col-xl-12 text-center lockedbody" style = "height:770px;"id="con">


                <form action="send.php" method="post">
                    <div class="form-group-inline text-center" id="loggroup">
                        <h1 class="formh"> Send Message </h1>
                        <div class="row justify-content-center">
                            <div class="logdiv center-block text-center">
                            <label>   <h1 class="footertext"> Recipient   </h1> </label>
                                <select class="custom-select custom-select-lg mb-3" name = 'user'>
...
while ($row = $recipientresult->fetch_assoc()) {
    ...
    echo "<option value ='"; echo htmlescape($recipientname); echo"'>"; echo htmlescape($recipientname); echo" </option>";
}
?>
                                </select>
                            </div>
